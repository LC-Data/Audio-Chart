...
plt.rcParams['animation.ffmpeg_path'] = r'C:\Users\Nathan\Downloads\ffmpeg-4.1-win64-static\ffmpeg-4.1-win64-static\bin\ffmpeg'
...
def inputData():
	...
	with open(r'C:\Users\Nathan\Desktop\BTCN.txt', 'r') as f:
	    for line in f:
...
def noteSet():			#This should eventually take an instrument/set of notes as a parameter
	...
	notesDirectory = r"C:\Users\Nathan\Downloads\Audio-Chart-master\Audio-Chart-master\violinWavs\\";						#path to your music note .wav files
...
def writeAudio(data, newFirstNote, testSamp, newSecondNote, trigger, indexOne, indexTwo):
	...
	if trigger == False:
		...
		p = wave.open(r"C:\Users\Nathan\Downloads\Audio-Chart-master\Audio-Chart-master\\TESTAUDIO.wav", 'wb');			#writing audio data
...
def averagize(graphData, notes):
	...
	notesTiedToData[maxVal] = r"C:\Users\Nathan\Downloads\Audio-Chart-master\Audio-Chart-master\violinWavs\z.wav";				# Turns the highest data value in to a clashing cymbal sound
...
def drawAndSave():
	...
	p = wave.open(r"C:\Users\Nathan\Downloads\Audio-Chart-master\Audio-Chart-master\\TESTAUDIO.wav", 'rb');			#reading audio data just for the params to calculate the length of the audio file
	frames = p.getnframes()
	rate = p.getframerate()
	...
	#plt.show();
	line_anim.save('TESTVIDEO.mp4', writer='writer');
