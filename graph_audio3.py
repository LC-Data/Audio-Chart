...
def averagize(graphData, notes):
	...
	notesTiedToData = OrderedDict(list(zip(sortedNewListOfDataPoints, notes)));	#zips your notes and data together in order from lowest to highest or what have you
	...
	print(list(notesTiedToData.keys()), " THESE ARE THE KEYS \n\n");
...
def drawAndSave():
	...
	line_anim = animation.FuncAnimation(fig, update_line, list(range(0,len(d))), fargs=(l, ), interval=(interval), blit=False, repeat=False);
