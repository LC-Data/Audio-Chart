...
def noteSet():			#This should eventually take an instrument/set of notes as a parameter
	...
	notesDirectory = "/var/www/html/hearCharts/hearCharts/violinWavs2/";						#path to your music note .wav files
...
def averagize(graphData, notes):
	...
	notesTiedToData[maxVal] = '/var/www/html/hearCharts/hearCharts/violinWavs2/z.wav';				# Turns the highest data value in to a clashing cymbal sound
...
def drawAndSave():
	...
	interval = ((((secondsLong) * 1000) - 625)/len(X_VALS));	#need to play with this sometimes to sync the clash perfectly (adding +/-1 after secondsLong is experimental)
